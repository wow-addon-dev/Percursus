...
L["options.general.debug-mode.name"] = "调试模式"
L["options.general.debug-mode.tooltip"] = "启用调试模式以在聊天框中显示额外信息。"
...
L["options.race-tracker.speed-display.tooltip"] = "决定竞速期间是否显示速度。此功能仅适用于驭龙术和驭空术竞速。"
