...
L["options.race-tracker-background.tooltip"] = "Определяет, какой фон будет использоваться для Race Tracker."
L["options.race-tracker-background.value.0"] = "Ничего"
L["options.race-tracker-background.value.1"] = "Percursus (Classic)"
L["options.race-tracker-background.value.2"] = "Альянс"
L["options.race-tracker-background.value.3"] = "Орда"
