...
L["options.race-tracker-mode.tooltip"] = "Как будет отображаться время во время гонки."
...
L["options.race-tracker-background-type.tooltip"] = "Какой фон будет использоваться для Race Tracker."
...
L["options.race-tracker-result-display.tooltip"] = "Следует ли продолжать отображать трекер гонки после гонки и, таким образом, представлять результаты гонки."
L["options.race-tracker-fadeout-delay.name"] = "Задержка затухания"
L["options.race-tracker-fadeout-delay.tooltip"] = "Время после гонки, по истечении которого трекер гонки будет скрыт."
L["options.race-tracker-hide-area-names.name"] = "Скрывать названия зон"
L["options.race-tracker-hide-area-names.tooltip"] = "Следует ли отображать названия зон во время гонки."
L["options.race-tracker-speed-display.name"] = "Показывать скорость гонки"
L["options.race-tracker-speed-display.tooltip"] = "Должна ли отображаться скорость гонки во время гонки. Этот дисплей работает только для гонок на Драконах и Скайрайдерах."
