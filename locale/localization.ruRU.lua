...
L["options.race-tracker-gliding-speed.tooltip"] = "Определяет, должна ли отображаться скорость гонки во время гонки. Это работает только для гонок на драконах и скайрайдерах."
...
L["options.race-tracker-background-type.value.0"] = "Percursus (Classic)"
L["options.race-tracker-background-type.value.1"] = "Alliance"
L["options.race-tracker-background-type.value.2"] = "Horde"
